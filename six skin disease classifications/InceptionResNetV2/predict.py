...
batch_size = 64
classNum=6
names=os.listdir('./6disease_new/test/')
image_path = "./6disease_new/"
rename='InceptionResNetV2'
...
covn_base = tf.keras.applications.InceptionResNetV2(weights='imagenet', include_top=False, input_shape=(im_width, im_height, 3))
...
def plotPictrue(fpr,tpr,roc_auc):
    ...
    save_name=['./'+rename+'-Algorithm-to-0-5-class-disease-sizeClass.png']
    lens=1
